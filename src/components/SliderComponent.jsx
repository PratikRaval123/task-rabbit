  ...
  return (
    <div className="container m-auto">
      ...
      <div className="bg-gradient shadow-sm md:rounded-xl sm:rounded-xl rounded-none w-full m-auto px-0 md:px-0 md:w-[80%]">
        <div className="flex justify-between gap-4 py-4 overflow-x-auto snap-x snap-mandatory md:overflow-x-visible">
          {tabs.map((tab) => (
            <button
              key={tab.id}
      ...
      {activeTab === "Assembly" && (
        <div className=" bg-gradient flex flex-col md:flex-row items-center md:items-start  p-6 md:p-10 rounded-lg ">
          {/* <div className="flex-1 bg-white p-6 shadow-md rounded-lg md:mr-6 mb-6 md:mb-0 ">
            <h2 className="text-lg font-semibold mb-4">Assembly</h2>
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="text-green-500 font-bold mr-2">✓</span>
                <p>Assemble or disassemble furniture items by unboxing, building, and any cleanup.</p>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 font-bold mr-2">✓</span>
                <p>Now Trending: Curved sofas, computer desks, and sustainable materials.</p>
              </li>
            </ul>
          </div>
          ...
          <div className="flex-1">
            <img
              src="https://images.ctfassets.net/vwt5n1ljn95x/2zLfFEV2MrXbcska0MocE7/32575342bd9f30397d58ccb663c71744/Homepage_Assembly.png?w=1080&q=75&fm=webp" // Replace with your image URL
            ...
            <div className="w-full md:w-1/2 p-4 ">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-green-500 font-bold mr-2">✓</span>
                  <p className="text-white text-lg">
                    Securely mount your TV, shelves, art, mirrors, dressers, and
                    more.
                  </p>
                </li>
                <li className="flex items-start">
      ...
      {activeTab === "Moving" && (
        <div className=" bg-gradient flex flex-col md:flex-row items-center md:items-start  p-6 md:p-10 rounded-lg ">
          <div className="flex flex-col md:flex-row items-center md:p-6 ">
            {/* Text Section */}
            <div className="w-full md:w-1/2 p-4 ">
              <h2 className="text-2xl font-semibold mb-4 text-white">Moving</h2>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-green-500 font-bold mr-2">✓</span>
                  <p className="text-white text-lg">
                    Moving help such as packing/unpacking, loading, and lifting
                    heavy items.
                  </p>
                </li>
                <li className="flex items-start">
            ...
            <div className="w-full md:w-1/2 p-4 ">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  <span className="text-green-500 font-bold mr-2">✓</span>
                  <p className="text-white text-lg">
                    Now Trending: Native plants, enhanced walkways, and outdoor
            ...
            <div className="w-full md:w-1/2 p-4 ">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-green-500 font-bold mr-2">✓</span>
                  <p className="text-white text-lg">
                    Paint walls, ceilings, molding, and doors; includes prep and
                    cleanup.
                  </p>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 font-bold mr-2">✓</span>
                  <p className="text-white text-lg">
                    Now Trending: Color blocking, stripe details, and statement
                    colors. .
                  </p>
                </li>
              </ul>
